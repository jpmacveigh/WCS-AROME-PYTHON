...
from allPrevisionsForId import allPrevisionsForId
import datetime
import os
...
covId=getWCSCapabilities("HIGHRES-AROME",resolution,"FRANCE")  # lance requête getCpabilities au WCS de MF
jeunesCovId=  list(filter(lambda x:x.ageRun() <=ageMaxi,covId["lesID"])) # on ne traite que les CoverageId qui ont moins de 8 heures d'age
